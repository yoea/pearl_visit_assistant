    ...
    case 'SCAN_SUCCEEDED':
      return state.stage === 'anonymized'
        ? {
            ...
            autoCleaned: event.autoCleaned, cleanIssues: event.cleanIssues,
          }
        : state;
    case 'ANALYSIS_SUCCEEDED':
      return state.stage === 'scanned'
        ? {
            ...
            result: event.result, report: event.report,
            autoCleaned: state.autoCleaned, cleanIssues: state.cleanIssues,
          }
        : state;
    case 'RETURN_TO_SCAN':
